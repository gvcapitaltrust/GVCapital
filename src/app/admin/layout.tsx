            ...
            <AdminProvider>
                <div className="min-h-screen bg-[#FAFAF8] text-gray-900 flex font-sans overflow-hidden">
                    ...
                    <main className="flex-1 flex flex-col h-screen overflow-hidden ring-1 ring-gray-200 shadow-sm">
                        {/* Header/Navbar */}
                        <header className="h-16 border-b border-gray-200 bg-[#FAFAF8]/80 backdrop-blur-md flex items-center justify-between px-4 lg:px-8 shrink-0 relative z-20">
                            <div className="flex items-center gap-4">
                                <button 
                                    onClick={() => setIsMobileMenuOpen(true)}
                                    className="lg:hidden h-9 w-9 flex items-center justify-center rounded-xl bg-white border border-gray-200 text-gray-400"
                                >
                                ...
                                <span className="hidden lg:block text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">GV Management Node</span>
