        ...
        <div className="space-y-12 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white border border-gray-200 rounded-[40px] p-8 space-y-4 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="text-2xl font-black text-gray-900 tracking-tight tabular-nums">$ {(platformStats.totalAssetsUSD || (totalAssets / forexRate)).toLocaleString(undefined, { minimumFractionDigits: 2 })} USD</div>
                </div>
