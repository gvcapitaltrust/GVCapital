...
export default function PortfolioClient({ lang }: { lang: "en" | "zh" }) {
    ...
    const t = {
        en: {
            ...
            subtitle: "Review client asset allocations and external platform mapping.",
            totalCaptial: "Total Assets Managed",
            allocated: "Allocated to Funds",
            unallocated: "Unallocated Balance",
            fundDistribution: "Fund Distribution",
            userMapping: "Allocation Status",
            mapped: "Allocated",
            unmapped: "Pending",
            manage: "Edit Allocation",
            user: "User",
