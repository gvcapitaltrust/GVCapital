...
export default function VerifyPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-700 flex flex-col items-center selection:bg-gv-gold selection:text-black">
            ...
            <div className="w-full max-w-3xl px-6 py-12 space-y-12">
                    ...
                    <div className="flex items-center gap-4 pt-4 w-full justify-center">
                        {[1, 2, 3].map((s: number) => (
                            <div key={s} className="flex items-center gap-2">
                                <div className={`h-8 w-8 rounded-full flex items-center justify-center text-[10px] font-black transition-all ${currentStep >= s ? 'bg-gv-gold text-black shadow-[0_0_15px_rgba(212,175,55,0.4)]' : 'bg-white text-gray-500 border border-gray-200'}`}>
                                    {s}
                                </div>
                                {s < 3 && <div className={`h-[1px] w-8 md:w-16 ${currentStep > s ? 'bg-gv-gold' : 'bg-gray-100'}`} />}
                            </div>
                        ))}
                    </div>
                </header>
                ...
                <main className="bg-[#141414] border border-gray-200 rounded-[48px] p-8 md:p-12 shadow-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="space-y-8 animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select value={formData.gender} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, gender: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none focus:border-gv-gold/50 transition-all">
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.address}</label>
                                    <input type="text" value={formData.address} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({...formData, address: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none focus:border-gv-gold/50 transition-all" placeholder={t.streetPlaceholder} />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.city}</label>
                                    <input type="text" value={formData.city} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({...formData, city: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none focus:border-gv-gold/50 transition-all" placeholder={t.cityPlaceholder} />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.phone}</label>
                                    <input type="tel" value={formData.phone} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({...formData, phone: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none focus:border-gv-gold/50 transition-all" placeholder="+60 12345678" />
                                </div>
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.taxId}</label>
                                    <input type="text" value={formData.tax_id} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({...formData, tax_id: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none focus:border-gv-gold/50 transition-all" placeholder={t.taxIdPlaceholder} />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 pt-4">
                                <button 
                                    ...
                                    className="flex-1 bg-white border border-gray-200 text-gray-900 font-black py-5 rounded-2xl hover:bg-gray-100 transition-all uppercase tracking-widest text-[11px]"
                                >
                                    {t.saveClose}
                                </button>
                                <button 
                                    onClick={nextStep} 
                                    className="flex-[2] bg-white border border-gray-200 text-gray-900 font-black py-5 rounded-2xl hover:bg-gv-gold hover:text-black transition-all uppercase tracking-[0.2em] text-[11px] shadow-lg"
                                >
                                    {t.nextStep}
                                </button>
                            </div>
                    ...
                    {currentStep === 2 && (
                        <div className="space-y-8 animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.purpose}</label>
                                    <select value={formData.account_purpose} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, account_purpose: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none transition-all">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.employment}</label>
                                    <select value={formData.employment_status} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, employment_status: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none transition-all">
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.industry}</label>
                                    <select value={formData.industry} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, industry: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none transition-all">
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.wealthSource}</label>
                                <div className="flex flex-wrap gap-2">
                                    {wealthSources.map((source, i) => (
                                        <button key={source} onClick={() => toggleWealthSource(content.en.wealthSources[i])} className={`px-5 py-2.5 rounded-xl text-[10px] font-black transition-all ${formData.source_of_wealth.includes(content.en.wealthSources[i]) ? 'bg-gv-gold text-black' : 'bg-white text-gray-400 border border-gray-200'}`}>
                                            {source}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.netWorth}</label>
                                    <select value={formData.total_wealth} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, total_wealth: e.target.value})} className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-[11px] font-black transition-all">
                                        {financialTiers.map((tier: string) => <option key={tier} value={tier}>{tier}</option>)}
                                    </select>
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.netIncome}</label>
                                    <select value={formData.annual_income} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, annual_income: e.target.value})} className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-[11px] font-black transition-all">
                                        {financialTiers.map((tier: string) => <option key={tier} value={tier}>{tier}</option>)}
                                    </select>
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.expectedDeposit}</label>
                                    <select value={formData.yearly_deposit} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFormData({...formData, yearly_deposit: e.target.value})} className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-[11px] font-black transition-all">
                                        {financialTiers.map((tier: string) => <option key={tier} value={tier}>{tier}</option>)}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 pt-4">
                                <button onClick={prevStep} className="flex-1 bg-white border border-gray-200 text-gray-900 font-black py-5 rounded-2xl hover:bg-gray-100 transition-all uppercase tracking-widest text-[11px]">{t.back}</button>
                                <button 
                                    onClick={() => handleFinalSubmit('Draft')} 
                                    className="flex-1 bg-white border border-gray-200 text-gray-900 font-black py-5 rounded-2xl hover:bg-gray-100 transition-all uppercase tracking-widest text-[11px]"
                                >
                        ...
                        <div className="space-y-10 animate-in fade-in duration-300">
                                        ...
                                        {idFront ? (
                                            <div className="absolute inset-0 p-4">
                                                ...
                                                <div className="absolute inset-0 flex flex-col items-center justify-center space-y-2">
                                                    ...
                                                    <span className="text-[9px] font-black uppercase text-gray-900 tracking-widest">{idFront.name}</span>
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="flex flex-col items-center space-y-4">
                                                <div className="h-12 w-12 rounded-full bg-white flex items-center justify-center group-hover:bg-gv-gold group-hover:text-white transition-all">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">{t.uploadPrompt}</span>
                                            </div>
                                        )}
                                        ...
                                        <div className="relative group border-2 border-gray-200 border-dashed rounded-[32px] overflow-hidden bg-white aspect-[3/2] flex flex-col items-center justify-center hover:bg-gray-50 transition-all border-dashed-2">
                                            {idBack ? (
                                                <div className="absolute inset-0 p-4">
                                                    ...
                                                    <div className="absolute inset-0 flex flex-col items-center justify-center space-y-2">
                                                        <svg className="h-10 w-10 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                                        <span className="text-[9px] font-black uppercase text-gray-900 tracking-widest">{idBack.name}</span>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="flex flex-col items-center space-y-4">
                            ...
                            <div id="bank-info-section" className="pt-8 border-t border-white/10 space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input type="text" value={formData.account_number} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({...formData, account_number: e.target.value})} className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-3.5 text-sm font-bold focus:outline-none focus:border-gv-gold/50 focus:ring-1 focus:ring-gv-gold/20 transition-all" placeholder="Enter account number" />
                                    </div>
                                    <div className="md:col-span-2 space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-1">{t.accHolder}</label>
                                ...
                                <div className="relative group border-2 border-gray-200 border-dashed rounded-[32px] overflow-hidden bg-white min-h-[160px] flex flex-col items-center justify-center hover:bg-gray-50 transition-all border-dashed-2">
                                    {bankStatement ? (
                                        <div className="flex flex-col items-center justify-center space-y-2 p-6">
                                            ...
                                            <span className="text-[10px] font-black uppercase text-gray-900 tracking-widest">{bankStatement.name}</span>
                                        </div>
                                    ) : (
                                        <div className="flex flex-col items-center space-y-4 p-6">
                                            ...
                                            <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">{t.uploadStatement}</span>
                                        </div>
                                    )}
                            ...
                            <div className="flex flex-col md:flex-row gap-4 pt-10">
                                ...
                                <button 
                                    onClick={() => handleFinalSubmit('Draft')} 
                                    disabled={isLoading}
                                    className="flex-1 bg-white border border-gray-200 text-gray-900 font-black py-5 rounded-2xl hover:bg-gray-100 transition-all uppercase tracking-widest text-[11px] flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                ...
                <footer className="text-center space-y-6">
                    <p className="text-[9px] text-gray-500 font-bold uppercase tracking-[0.2em] max-w-xl mx-auto leading-loose">
                        {t.footerNote}
                    </p>
                </footer>
            </div>
            ...
            {showSuccess && (
                <div className="fixed inset-0 z-[500] bg-gray-900/40 backdrop-blur-md flex items-center justify-center p-6 animate-in fade-in duration-700">
                    <div className="bg-gray-50 border border-gv-gold/30 rounded-[40px] p-10 max-w-md w-full text-center space-y-8 shadow-2xl animate-in zoom-in-95 duration-500">
                        ...
                        <div className="space-y-4">
                            <h2 className="text-3xl font-black uppercase tracking-tighter text-gray-900">{t.verificationStarted}</h2>
