        ...
        <div className="max-w-4xl mx-auto space-y-12 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-8">
                    <div className="premium-glass bg-white border-slate-200 rounded-[40px] p-8 md:p-12 shadow-2xl space-y-12 transition-all duration-700">
                ...
                <div className="space-y-8">
                    <div className="premium-glass bg-slate-50 border border-slate-200 rounded-[40px] p-10 shadow-2xl relative overflow-hidden group">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 block mb-8">{t.currentTier}</span>
                        <div className="flex items-center gap-6 relative z-10">
                            ...
                            <div className="flex flex-col">
                                <span className="text-2xl font-black text-slate-900 uppercase tracking-tighter leading-none mb-1">
                    ...
                    <div className="bg-gv-gold/5 border border-gv-gold/20 rounded-[40px] p-10 space-y-6 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] relative overflow-hidden group/security">
                        ...
                        <div className="space-y-3 relative z-10">
                            <h4 className="text-[12px] font-black uppercase tracking-[0.3em] text-slate-900">Institutional Security</h4>
                            <p className="text-[10px] font-bold text-slate-500 leading-relaxed uppercase tracking-[0.15em] opacity-80">
            ...
            {showPenaltyConfirm && penaltyInfo && (
                <div className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-white/60 backdrop-blur-md">
                    <div className="premium-glass bg-white border border-slate-200 rounded-[40px] p-10 md:p-12 max-w-lg w-full space-y-10 shadow-2xl animate-in fade-in zoom-in-95 duration-500">
                        <div className="h-24 w-24 bg-amber-500/10 rounded-full flex items-center justify-center mx-auto border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.1)] ring-4 ring-amber-500/5">
                            <AlertTriangle className="h-12 w-12 text-amber-500" strokeWidth={3} />
                        </div>
                        <div className="text-center space-y-3">
                            <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tighter">{t.penaltyTitle}</h3>
                            <p className="text-slate-500 font-semibold text-sm leading-relaxed px-4">{t.penaltyDesc}</p>
                        </div>
                        <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100 space-y-5 shadow-inner">
                            <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-[0.25em] text-slate-500">
                                ...
                                <span className="text-slate-700 font-mono">$ {(penaltyInfo.lockedPortion_usd || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                            </div>
                            ...
                            <div className="flex justify-between items-center text-xs font-black uppercase tracking-[0.3em] text-emerald-600">
            ...
            {isPinModalOpen && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-white/80 backdrop-blur-xl">
                    <div className="premium-glass bg-white border border-slate-200 rounded-[40px] p-12 max-w-md w-full text-center space-y-12 shadow-2xl animate-in fade-in zoom-in-90 duration-500">
                        <div className="space-y-3">
                            <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tighter">{t.securityPin}</h3>
                            <p className="text-slate-500 font-semibold text-sm px-4 leading-relaxed">{t.enterPin}</p>
                        </div>
                        <div className="relative flex justify-center items-center group">
                            <input
                                ...
                                className="w-full bg-slate-50 border border-slate-200 rounded-[32px] p-8 text-6xl font-black text-center tracking-[0.4em] focus:outline-none focus:border-gv-gold/50 transition-all text-gv-gold placeholder:text-slate-200 flex-1 shadow-inner tabular-nums"
                                autoFocus
                                placeholder="000000"
                            />
                            <button 
