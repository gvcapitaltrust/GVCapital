        ...
        <div className="max-w-4xl mx-auto space-y-12 pb-20">
            ...
            {!user?.is_verified && (
                <div className="premium-glass border-amber-500/20 rounded-[32px] p-10 flex flex-col md:flex-row items-center gap-8 animate-in slide-in-from-top-4 duration-500">
                    <div className="h-16 w-16 rounded-2xl bg-amber-500/10 flex items-center justify-center text-amber-500 shrink-0 shadow-[0_0_20px_rgba(245,158,11,0.1)]">
                        <Upload className="h-8 w-8" />
                    </div>
                    <div className="flex-1 text-center md:text-left space-y-2">
                        <h3 className="text-xl font-black text-gray-200 uppercase tracking-tight">Identity Verification Required</h3>
                        <p className="text-sm font-medium text-gray-500 leading-relaxed">To comply with global financial regulations, you must complete your identity verification (KYC) before initiating a deposit request.</p>
                    </div>
                    <button 
            ...
            <div className={`premium-glass border-gv-gold/10 rounded-[40px] p-10 md:p-14 shadow-2xl space-y-12 transition-all duration-700 ${!user?.is_verified ? 'opacity-40 grayscale pointer-events-none select-none' : ''}`}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="space-y-10">
                        ...
                        <div className="space-y-4">
                            ...
                            <input 
                                ...
                                className="w-full bg-black/40 border border-white/5 rounded-3xl p-7 text-xl font-bold focus:outline-none focus:border-gv-gold/50 focus:bg-black/60 transition-all text-white inverted-scheme-date-picker shadow-inner" 
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <textarea 
                                ...
                                className="w-full bg-black/40 border border-white/5 rounded-3xl p-7 text-sm font-semibold focus:outline-none focus:border-gv-gold/50 focus:bg-black/60 transition-all min-h-[160px] text-gray-300 shadow-inner leading-relaxed" 
                    ...
                    <div className="space-y-10">
                        <div className="space-y-4 h-full flex flex-col">
                            ...
                            <div className="relative group border-2 border-white/5 border-dashed rounded-[32px] overflow-hidden bg-black/20 flex-1 min-h-[400px] flex flex-col items-center justify-center hover:bg-black/40 transition-all cursor-pointer shadow-inner">
                                {depositReceipt ? (
                                    ...
                                    <div className="flex flex-col items-center space-y-6 p-10 text-center">
                                        <div className="h-24 w-24 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-gv-gold/10 group-hover:border-gv-gold/40 transition-all shadow-2xl relative">
                                            <div className="absolute inset-0 bg-gv-gold/10 blur-[30px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                            <Upload className="h-10 w-10 text-white/20 group-hover:text-gv-gold transition-colors relative z-10" strokeWidth={1.5} />
                                        </div>
                                        <div>
                                            <p className="text-[11px] font-black text-white/60 uppercase tracking-[0.4em] mb-2">{t.selectFile}</p>
                                            <p className="text-[9px] text-gray-500 font-bold tracking-widest uppercase">Verified JPG, PNG or PDF (Max 10MB)</p>
                                        </div>
                                    </div>
                                )}
            ...
            <div className="premium-glass bg-black/40 border-gv-gold/10 rounded-[32px] p-10 text-center shadow-xl">
                <p className="text-[10px] text-gray-500 font-bold uppercase tracking-[0.25em] max-w-2xl mx-auto leading-relaxed">
