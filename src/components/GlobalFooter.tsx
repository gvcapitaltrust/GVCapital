...
export default function GlobalFooter() {
    ...
    return (
        <footer className="w-full border-t border-white/5 bg-[var(--bg-primary)]/50 backdrop-blur-sm py-12 px-6 mt-auto font-body">
            <div className="mx-auto max-w-7xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-8">
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 grayscale opacity-50">
                            ...
                            />
                            <span className="text-sm font-heading font-light tracking-tighter text-white/50">GV CAPITAL TRUST</span>
                        </div>
                        <p className="text-[10px] text-zinc-500 max-w-md leading-relaxed font-body font-light uppercase tracking-wider">
                            {t.disclaimer}
                        </p>
                    </div>

                    <div className="flex flex-col items-start md:items-end gap-4">
                        <div className="flex flex-wrap gap-6 text-[10px] font-heading font-light uppercase tracking-widest text-zinc-500">
                        ...
                        <div className="flex items-center gap-2 text-zinc-600">
                            ...
                            <span className="text-[10px] font-heading font-light uppercase tracking-[0.2em]">{t.location}</span>
                        </div>
                        <p className="text-[8px] text-zinc-700 max-w-xs text-left md:text-right leading-tight font-body font-light uppercase tracking-widest mt-2 border-t border-white/5 pt-4">
                            {lang === "en"
                ...
                <div className="pt-8 border-t border-white/[0.02] flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-[10px] text-zinc-600 font-heading font-light uppercase tracking-widest">
                        {t.copyright}
                    </p>
                    <div className="flex items-center gap-2 text-zinc-700 opacity-50">
                        ...
                        <span className="text-[9px] font-heading font-light uppercase tracking-[0.3em] font-mono">SSL 256-BIT ENCRYPTED</span>
                    </div>
                </div>
            </div>
            ...
            >
                <div className="absolute right-full mr-4 bg-white text-black text-[10px] font-heading font-light uppercase tracking-widest py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl border border-black/5 whitespace-nowrap mb-2">
