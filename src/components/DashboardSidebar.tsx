...
export default function DashboardSidebar({ lang, isCollapsed, onToggleCollapse, onOpenMobileMenu }: DashboardSidebarProps) {
    ...
    const menuItems = [
        ...
        { id: "fund-accounts", path: "/dashboard/fund-accounts", label: t.fundPerformance, icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>, isRestricted: !isVerified },
        ...
        <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-[50] h-20 bg-[#FAFAF8]/90 backdrop-blur-2xl border-t border-gray-200 flex items-center justify-around px-2 md:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.03)]">
                {[
                    ...
                    { id: "withdraw", path: "/dashboard/withdraw", label: "WITHDRAWAL", icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>, isRestricted: !isVerified },
