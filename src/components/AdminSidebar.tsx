...
export default function AdminSidebar({ 
    ...
    const menuItems = [
        ...
        { id: "fund-accounts", path: "/admin/fund-accounts", label: t.tabs.fundAccounts, icon: <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg> },
        { id: "wallet-addresses", path: "/admin/wallet-addresses", label: t.tabs.walletAddresses, icon: <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path d="M3 10h18M3 6h18v12H3V6zm14 6a1 1 0 11-2 0 1 1 0 012 0z"/></svg> },
